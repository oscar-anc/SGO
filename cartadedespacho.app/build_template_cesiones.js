/**
 * build_template_cesiones.js
 * ============================
 * Generates template_cesiones.docx — Cesiones de Derecho annex.
 *
 * Requires: docx, adm-zip  →  npm install adm-zip
 * Run:      node build_template_cesiones.js
 *
 * ── Strategy ──────────────────────────────────────────────────────────────
...
// Extracted from CESIONES_DE_DERECHO.docx and cleaned:
...
// Navy background, logo, title "CESIONES DE DERECHO", {companyName}
// =============================================================================
...
function buildCoverChildren() {
    ...
    // Title: "CESIONES DE DERECHO" in Marsh Serif 32pt bold white allCaps
    children.push(new Paragraph({
        children:  [rWB('Cesiones de Derecho', { font: FONT_MARSH, size: SZ_32, caps: true })],
        alignment: AlignmentType.LEFT,
        spacing:   SP_ZERO,
    }));
...
async function buildDocument() {
    ...
    // ── Write final file ──────────────────────────────────────────────────────
    fs.writeFileSync('template_cesiones.docx', zip.toBuffer());
    console.log('✓ Written: template_cesiones.docx');
