...
QSSD = {
    ...
    'app_bg':                       '#f0f3f6',   # QPalette.Window + QPalette.Button
    ...
    'scrollbar_track_bg':           '#f0f3f6',
    'scrollbar_border':             'none',
    'scrollbar_width':              '10',
    'scrollbar_margin':             '0',
    'scrollbar_handle_bg':          '#ced6dc',
    'scrollbar_handle_radius':      '5px',
    'scrollbar_handle_min':         '30',
    'scrollbar_handle_margin':      '1px',
    'scrollbar_handle_bg_hover':    '#959fa9',
    'scrollbar_handle_bg_pressed':  '#4f5f6f',
    ...
    'radio_widget_color':           '#4f5f6f',
    'radio_widget_bg':              'transparent',
    'radio_widget_border':          'none',
    'radio_widget_outline':         'none',
    # typography
    'radio_font_family':                'Outfit',
    'radio_font_size':                  '10pt',
    'radio_font_weight':                '400',
    'radio_spacing':                '12',
    # indicator
    'radio_indicator_size':         '16',
    'radio_indicator_radius':       '8px',
    'radio_indicator_bg':           '#FFFFFF',
    # indicator border sides (all equal at rest)
    'radio_border_top':             '1px solid #33536d',
    'radio_border_right':           '1px solid #33536d',
    'radio_border_bottom':          '1px solid #33536d',
    'radio_border_left':            '1px solid #33536d',
    # hover
    'radio_border_top_hover':       '1px solid #59c2e6',
    'radio_border_right_hover':     '1px solid #59c2e6',
    'radio_border_bottom_hover':    '1px solid #59c2e6',
    'radio_border_left_hover':      '1px solid #59c2e6',
    # checked — gradient encodes all stop values as a single CSS string
    'radio_checked_gradient':       'qradialgradient(cx:0.5, cy:0.5, radius:0.5, fx:0.5, fy:0.5, stop:0 #33536d, stop:0.4 #33536d, stop:0.45 #FFFFFF, stop:1 #FFFFFF)',
    'radio_border_top_checked':     '1px solid #33536d',
    'radio_border_right_checked':   '1px solid #33536d',
    'radio_border_bottom_checked':  '1px solid #33536d',
    'radio_border_left_checked':    '1px solid #33536d',
    ...
    'lineedit_bg':                  '#FFFFFF',
    'lineedit_color':               '#4f5f6f',
    'lineedit_padding':             '7px 10px',
    'lineedit_min_height':          '28',
    'lineedit_min_width':           '60',
    'lineedit_selection_bg':        '#59c2e6',
    'lineedit_outline':             'none',
    # typography
    'lineedit_font_family':             'Outfit',
    'lineedit_font_size':               '10pt',
    'lineedit_font_weight':             '400',
    'lineedit_radius':              '2px',
    # border sides — rest
    'lineedit_border_top':          '1px solid #C8D0D8',
    'lineedit_border_right':        '1px solid #C8D0D8',
    'lineedit_border_bottom':       '1px solid #C8D0D8',
    'lineedit_border_left':         '1px solid #C8D0D8',
    # border sides — hover
    'lineedit_border_top_hover':    '1px solid #33536d',
    'lineedit_border_right_hover':  '1px solid #33536d',
    'lineedit_border_bottom_hover': '1px solid #33536d',
    'lineedit_border_left_hover':   '1px solid #33536d',
    # border sides — focus
    'lineedit_border_top_focus':    '1px solid #33536d',
    'lineedit_border_right_focus':  '1px solid #33536d',
    'lineedit_border_bottom_focus': '1px solid #33536d',
    'lineedit_border_left_focus':   '1px solid #33536d',
    # border sides — read-only / disabled (same as rest)
    'lineedit_border_top_ro':       '1px solid #C8D0D8',
    'lineedit_border_right_ro':     '1px solid #C8D0D8',
    'lineedit_border_bottom_ro':    '1px solid #C8D0D8',
    'lineedit_border_left_ro':      '1px solid #C8D0D8',
    # states
    'lineedit_bg_readonly':         '#e1ecf7',
    'lineedit_bg_disabled':         '#e1ecf7',
    'lineedit_color_disabled':      '#a1b1c2',
    # ── CardWidget Header sub-section (QLineEdit#CardTitle) ──────────────────
    'lineedit_card_header_bg':              'transparent',
    'lineedit_card_header_color':           '#FFFFFF',
    ...
    'lineedit_card_header_radius':          '2px',
    'lineedit_card_header_font_size':       '9pt',
    'lineedit_card_header_padding':         '2px 4px',
    'lineedit_card_header_min_height':      '24',
    'lineedit_card_header_selection_bg':    'rgba(255,255,255,80)',
    # typography
    'lineedit_card_header_font_family': 'Outfit',
    ...
    'combobox_bg':                  '#FFFFFF',
    'combobox_color':               '#4f5f6f',
    'combobox_padding':             '4px 8px',
    'combobox_min_height':          '28',
    'combobox_min_width':           '60',
    'combobox_selection_bg':        '#59c2e6',
    'combobox_outline':             'none',
    # typography
    'combobox_font_family':             'Outfit',
    'combobox_font_size':               '10pt',
    'combobox_font_weight':             '400',
    'combobox_radius':              '2px',
    # border sides — rest
    'combobox_border_top':          '1px solid #C8D0D8',
    'combobox_border_right':        '1px solid #C8D0D8',
    'combobox_border_bottom':       '1px solid #C8D0D8',
    'combobox_border_left':         '1px solid #C8D0D8',
    # border sides — hover
    'combobox_border_top_hover':    '1px solid #33536d',
    'combobox_border_right_hover':  '1px solid #33536d',
    'combobox_border_bottom_hover': '1px solid #33536d',
    'combobox_border_left_hover':   '1px solid #33536d',
    # border sides — focus
    'combobox_border_top_focus':    '1px solid #33536d',
    'combobox_border_right_focus':  '1px solid #33536d',
    'combobox_border_bottom_focus': '1px solid #33536d',
    'combobox_border_left_focus':   '1px solid #33536d',
    # drop-down arrow area
    'combobox_arrow_area_width':    '24',
    'combobox_arrow_area_border':   'none',
    ...
    'combobox_popup_bg':            '#FFFFFF',
    'combobox_popup_color':         '#4f5f6f',
    'combobox_popup_border_top':    '1px solid #C8D0D8',
    'combobox_popup_border_right':  '1px solid #C8D0D8',
    'combobox_popup_border_bottom': '1px solid #C8D0D8',
    'combobox_popup_border_left':   '1px solid #C8D0D8',
    'combobox_popup_radius':        '2px',
    'combobox_popup_outline':       'none',
    'combobox_popup_padding':       '2px',
    # typography — popup list and items
    'combobox_popup_font_family':       'Outfit',
    'combobox_popup_font_size':         '10pt',
    'combobox_popup_font_weight':       '400',
    'combobox_item_font_family':        'Outfit',
    'combobox_item_font_size':          '10pt',
    'combobox_item_font_weight':        '400',
    'combobox_popup_selection_bg':  '#59c2e6',
    # popup item
    'combobox_item_min_height':     '28',
    'combobox_item_padding':        '2px 8px',
    'combobox_item_radius':         '2px',
    'combobox_item_bg_hover':       '#59c2e6',
    'combobox_item_color_hover':    '#4f5f6f',
    'combobox_item_bg_selected':    '#4f5f6f',
    ...
    'combobox_card_header_font_family':     'Outfit',
    'combobox_card_header_font_size':       '9pt',
    'combobox_card_header_font_weight':     '600',
    'combobox_card_header_padding':         '2px 4px',
    'combobox_card_header_min_height':      '24',
    ...
    'dateedit_bg':                  '#FFFFFF',
    'dateedit_color':               '#4f5f6f',
    'dateedit_padding':             '7px 10px',
    'dateedit_min_height':          '28',
    'dateedit_min_width':           '120',
    'dateedit_outline':             'none',
    # typography
    'dateedit_font_family':             'Outfit',
    'dateedit_font_size':               '10pt',
    'dateedit_font_weight':             '400',
    'dateedit_radius':              '2px',
    # border sides — rest
    'dateedit_border_top':          '1px solid #C8D0D8',
    'dateedit_border_right':        '1px solid #C8D0D8',
    'dateedit_border_bottom':       '1px solid #C8D0D8',
    'dateedit_border_left':         '1px solid #C8D0D8',
    # border sides — hover
    'dateedit_border_top_hover':    '1px solid #33536d',
    'dateedit_border_right_hover':  '1px solid #33536d',
    'dateedit_border_bottom_hover': '1px solid #33536d',
    'dateedit_border_left_hover':   '1px solid #33536d',
    # border sides — focus
    'dateedit_border_top_focus':    '1px solid #33536d',
    'dateedit_border_right_focus':  '1px solid #33536d',
    'dateedit_border_bottom_focus': '1px solid #33536d',
    'dateedit_border_left_focus':   '1px solid #33536d',
    # drop-down arrow area
    'dateedit_arrow_area_width':    '24',
    'dateedit_arrow_area_border':   'none',
    'dateedit_arrow_img':           'url(imgs/calendar.svg)',
    'dateedit_arrow_size':          '16',
    ...
    'cal_bg':                       '#FFFFFF',
    'cal_border_top':               '1px solid #475564',
    'cal_border_right':             '1px solid #475564',
    'cal_border_bottom':            '1px solid #475564',
    'cal_border_left':              '1px solid #475564',
    'cal_min_height':               '220',
    # navigation bar
    'cal_nav_bg':                   '#4f5f6f',
    'cal_nav_padding':              '3px',
    'cal_nav_min_height':           '36',
    # QAbstractItemView
    'cal_view_bg':                  '#FFFFFF',
    'cal_view_color':               '#4f5f6f',
    'cal_view_selected_bg':         '#59c2e6',
    'cal_view_selected_color':      '#FFFFFF',
    'cal_view_gridline':            '#dce6f0',
    'cal_view_outline':             'none',
    # typography
    'cal_view_font_family':             'Outfit',
    'cal_view_font_size':               '10pt',
    'cal_view_font_weight':             '400',
    'cal_view_disabled_color':      '#a1b1c2',
    'cal_view_item_hover_bg':       '#e8f0f8',
    'cal_view_item_hover_color':    '#4f5f6f',
    'cal_view_item_hover_radius':   '2px',
    'cal_view_item_selected_bg':    '#59c2e6',
    'cal_view_item_selected_color': '#FFFFFF',
    'cal_view_item_selected_radius':'2px',
    # QToolButton
    'cal_toolbtn_bg':               'transparent',
    'cal_toolbtn_color':            '#FFFFFF',
    'cal_toolbtn_border_top':       'none',
    'cal_toolbtn_border_right':     'none',
    'cal_toolbtn_border_bottom':    'none',
    'cal_toolbtn_border_left':      'none',
    'cal_toolbtn_radius':           '0px',
    'cal_toolbtn_padding':          '3px 8px',
    # font-weight flag: 'bold' or 'normal'
    'cal_tool_font_weight':         'bold',
    # typography
    'cal_toolbtn_font_family':          'Outfit',
    'cal_toolbtn_font_size':            '10pt',
    'cal_toolbtn_font_weight':          '700',
    'cal_toolbtn_hover_bg':         '#3aaac8',
    'cal_toolbtn_hover_radius':     '0px',
    'cal_toolbtn_menu_indicator':   'none',
    # nav arrow icons
    'cal_arrow_prev_img':           'url(imgs/arrow_left.svg)',
    'cal_arrow_next_img':           'url(imgs/arrow_right.svg)',
    'cal_arrow_icon_size':          '16',
    # QSpinBox (year)
    'cal_spinbox_bg':               'transparent',
    'cal_spinbox_color':            '#FFFFFF',
    'cal_spinbox_border_top':       'none',
    'cal_spinbox_border_right':     'none',
    'cal_spinbox_border_bottom':    'none',
    'cal_spinbox_border_left':      'none',
    'cal_spinbox_selection_bg':     '#59c2e6',
    # typography
    'cal_spinbox_font_family':          'Outfit',
    'cal_spinbox_font_size':            '10pt',
    'cal_spinbox_font_weight':          '400',
    'cal_spinbox_updown_width':     '0',
    # QHeaderView (weekday labels)
    'cal_header_bg':                '#4f5f6f',
    'cal_header_color':             '#FFFFFF',
    'cal_header_border_top':        'none',
    'cal_header_border_right':      'none',
    'cal_header_border_bottom':     'none',
    'cal_header_border_left':       'none',
    'cal_header_font_weight':       'bold',
    # typography
    'cal_header_font_family':           'Outfit',
    'cal_header_font_size':             '10pt',

    # =========================================================================
    # S8  QCHECKBOX
    # =========================================================================

    'checkbox_widget_color':        '#4f5f6f',
    'checkbox_widget_bg':           'transparent',
    'checkbox_widget_border':       'none',
    'checkbox_widget_outline':      'none',
    # typography
    'checkbox_font_family':             'Outfit',
    'checkbox_font_size':               '10pt',
    ...
    'checkbox_indicator_border_top':    '1px solid #33536d',
    'checkbox_indicator_border_right':  '1px solid #33536d',
    'checkbox_indicator_border_bottom': '1px solid #33536d',
    'checkbox_indicator_border_left':   '1px solid #33536d',
    # hover
    'checkbox_indicator_border_top_hover':    '1px solid #59c2e6',
    'checkbox_indicator_border_right_hover':  '1px solid #59c2e6',
    'checkbox_indicator_border_bottom_hover': '1px solid #59c2e6',
    'checkbox_indicator_border_left_hover':   '1px solid #59c2e6',
    # checked
    'checkbox_indicator_bg_checked':    '#59c2e6',
    'checkbox_indicator_border_top_checked':    '1px solid #3aaac8',
    'checkbox_indicator_border_right_checked':  '1px solid #3aaac8',
    'checkbox_indicator_border_bottom_checked': '1px solid #3aaac8',
    'checkbox_indicator_border_left_checked':   '1px solid #3aaac8',
    'checkbox_indicator_img_checked':   'url(imgs/check.svg)',
    # indeterminate
    'checkbox_indicator_bg_indeterminate':  '#59c2e6',
    'checkbox_indicator_border_top_indeterminate':    '1px solid #3aaac8',
    'checkbox_indicator_border_right_indeterminate':  '1px solid #3aaac8',
    'checkbox_indicator_border_bottom_indeterminate': '1px solid #3aaac8',
    'checkbox_indicator_border_left_indeterminate':   '1px solid #3aaac8',
    'checkbox_indicator_img_indeterminate': 'url(imgs/check_indeterminate.svg)',
    # disabled
    'checkbox_indicator_bg_disabled':   '#e0e8f0',
    'checkbox_indicator_border_top_disabled':    '1px solid #a1b1c2',
    'checkbox_indicator_border_right_disabled':  '1px solid #a1b1c2',
    'checkbox_indicator_border_bottom_disabled': '1px solid #a1b1c2',
    'checkbox_indicator_border_left_disabled':   '1px solid #a1b1c2',
    'checkbox_indicator_img_disabled':  'url(imgs/check_disabled.svg)',
    ...
    # typography
    'groupbox_font_family':             'Outfit',
    'groupbox_title_font_family':       'Outfit',
    ...
    'btn_excel_icon_size':          '22',
    'btn_excel_icon_bg_hover':      '#217346',

    # ── Excel text (role="excel-text") ────────────────────────────────────────
    'btn_excel_text_bg':            '#4caf7d',
    ...
    # typography
    'btn_excel_text_font_family':       'Outfit',
    ...
    'btn_download_color':           '#217346',
    'btn_download_border_top':      '1px solid #217346',
    'btn_download_border_right':    '1px solid #217346',
    'btn_download_border_bottom':   '1px solid #217346',
    'btn_download_border_left':     '1px solid #217346',
    'btn_download_radius':          '4px',
    'btn_download_padding':         '0px 12px',
    'btn_download_height':          '30',
    # typography
    'btn_download_font_family':         'Outfit',
    ...
    'btn_endtable_view_bg':         '#FFFFFF',
    'btn_endtable_view_color':      '#4f5f6f',
    'btn_endtable_view_border_top': '1px solid #C8D0D8',
    'btn_endtable_view_border_right':'1px solid #C8D0D8',
    'btn_endtable_view_border_bottom':'1px solid #C8D0D8',
    'btn_endtable_view_border_left':'1px solid #C8D0D8',
    'btn_endtable_view_radius':     '4px',
    'btn_endtable_view_padding':    '2px',
    'btn_endtable_view_size':       '22',
    'btn_endtable_view_bg_hover':   '#e1ecf7',

    # ── EndorsementTableCard header: Editar (role="endtable-edit") ───────────
    'btn_endtable_edit_bg':         '#FFFFFF',
    'btn_endtable_edit_color':      '#4f5f6f',
    'btn_endtable_edit_border_top': '1px solid #C8D0D8',
    'btn_endtable_edit_border_right':'1px solid #C8D0D8',
    'btn_endtable_edit_border_bottom':'1px solid #C8D0D8',
    'btn_endtable_edit_border_left':'1px solid #C8D0D8',
    'btn_endtable_edit_radius':     '4px',
    'btn_endtable_edit_padding':    '2px',
    'btn_endtable_edit_size':       '22',
    'btn_endtable_edit_bg_hover':   '#e1ecf7',

    # ── EndorsementTableCard header: Import Excel (role="endtable-import") ───
    'btn_endtable_import_bg':       '#4caf7d',
    ...
    'btn_endtable_import_size':     '22',
    'btn_endtable_import_bg_hover': '#217346',
    ...
    'btn_manual_bg':                '#FFFFFF',
    'btn_manual_color':             '#4f5f6f',
    'btn_manual_border_top':        '1px solid #C8D0D8',
    'btn_manual_border_right':      '1px solid #C8D0D8',
    'btn_manual_border_bottom':     '1px solid #C8D0D8',
    'btn_manual_border_left':       '1px solid #C8D0D8',
    'btn_manual_radius':            '4px',
    'btn_manual_padding':           '5px 8px',
    'btn_manual_min_height':        '28',
    'btn_manual_text_align':        'left',
    # typography
    'btn_manual_font_family':           'Outfit',
    'btn_manual_font_size':             '10pt',
    'btn_manual_font_weight':           '400',
    'btn_manual_bg_hover':          '#e8f4fd',
    'btn_manual_border_color_hover':'#59c2e6',
    'btn_manual_bg_checked':        '#e8f4fd',
    'btn_manual_border_color_checked':'#59c2e6',
    'btn_manual_color_checked':     '#3aaac8',
    'btn_manual_font_weight_checked':'bold',
    'btn_manual_bg_disabled':       '#FFFFFF',
    'btn_manual_border_color_disabled':'#C8D0D8',
    'btn_manual_color_disabled':    '#4f5f6f',
    'btn_manual_font_weight_disabled':'normal',

    # ── Manual fixed (role="manual-fixed") — Aspectos Generales ──────────────
    'btn_manual_fixed_bg':          '#FFFFFF',
    'btn_manual_fixed_color':       '#888888',
    'btn_manual_fixed_border_top':  '1px solid #59c2e6',
    'btn_manual_fixed_border_right':'1px solid #59c2e6',
    'btn_manual_fixed_border_bottom':'1px solid #59c2e6',
    'btn_manual_fixed_border_left': '1px solid #59c2e6',
    'btn_manual_fixed_radius':      '4px',
    'btn_manual_fixed_padding':     '5px 8px',
    'btn_manual_fixed_min_height':  '28',
    'btn_manual_fixed_text_align':  'left',
    # typography
    'btn_manual_fixed_font_family':     'Outfit',
    'btn_manual_fixed_font_size':       '10pt',
    'btn_manual_fixed_font_weight': 'bold',
    # disabled same as normal (intentional locked state)
    'btn_manual_fixed_bg_disabled':     '#FFFFFF',
    'btn_manual_fixed_color_disabled':  '#888888',
    'btn_manual_fixed_border_top_disabled':  '1px solid #59c2e6',
    'btn_manual_fixed_border_right_disabled':'1px solid #59c2e6',
    'btn_manual_fixed_border_bottom_disabled':'1px solid #59c2e6',
    'btn_manual_fixed_border_left_disabled': '1px solid #59c2e6',
    ...
    # typography
    'tree_font_family':                 'Outfit',
    'tree_font_size':                   '10pt',
    'tree_font_weight':                 '400',
    'tree_item_font_family':            'Outfit',
    ...
    'navbar_bg':                    '#f0f3f6',
    'navbar_min_height':            '56',
    'navbar_max_height':            '56',
    'navbar_border_top':            '1px solid #dce6f0',
    ...
    'card_header_min_height':       '36',
    'card_header_max_height':       '36',
    'card_header_padding':          '0 12px',
    'card_header_radius':           '0px',
    'card_header_border_top':       'none',
    'card_header_border_right':     'none',
    'card_header_border_bottom':    'none',
    'card_header_border_left':      'none',
    ...
    # typography
    'card_title_font_family':           'Outfit',
    'card_title_font_size':             '10pt',
    'card_title_font_weight':           '700',
    'card_toggle_font_family':          'Outfit',
    'card_toggle_font_size':            '10pt',
    'card_toggle_font_weight':          '700',
    # #CardToggle (chevron label)
    'card_toggle_color':            '#FFFFFF',
    ...
    # #CardBody
    'card_body_bg':                 '#FFFFFF',
    'card_body_padding':            '12px',
    'card_body_radius':             '0px',
    'card_body_border_top':         'none',
    # border shorthand properties (used with border-width/style/color/top)
    'card_body_border_width':       '1px',
    'card_body_border_style':       'solid',
    'card_body_border_color':       '#4f5f6f',
    ...
    # typography
    'msg_btn_primary_font_family':      'Outfit',
    'msg_btn_primary_font_size':        '10pt',
    'msg_btn_primary_font_weight':      '700',
    'msg_btn_secondary_font_family':    'Outfit',
    ...
    # typography
    'endcard_label_font_family':        'Outfit',
    ...
    # typography
    'insured_hdr_label_font_family':    'Outfit',
    ...
    'titlebar_btn_text':            '#FFFFFF',        # icon color for min/max/close buttons
    'titlebar_btn_hover_bg':        '#59c2e6',        # min/max hover background
    'titlebar_btn_pressed_bg':      '#3aaac8',        # min/max pressed background
    'titlebar_close_hover_bg':      '#fc4c7a',        # close button hover background
    'titlebar_close_pressed_bg':    '#d93060',        # close button pressed background
    'titlebar_bg':                  '#4f5f6f',
    'titlebar_min_height':          '32',
    'titlebar_max_height':          '32',
    # #AppTitleLabel
    'titlebar_label_color':         '#FFFFFF',
    'titlebar_label_bg':            'transparent',
    'titlebar_label_font_weight':   'bold',
    # typography
    'titlebar_label_font_family':       'Outfit',
    'titlebar_label_font_size':         '10pt',
    'titlebar_label_font_size':     '10pt',
    # button sizes (shared between min/max/close for consistent bar)
    'titlebar_btn_width':           '32',
    'titlebar_btn_height':          '32',
    ...
    # typography
    'instruction_label_font_family':    'Outfit',
    'instruction_label_font_size':      '9pt',
    ...
    # typography
    'tab_font_family':                  'Outfit',
    'tab_font_size':                    '10pt',
    'tab_font_weight':                  '400',
    'tab_selected_font_family':         'Outfit',
    ...
    # typography
    'toolbar_btn_font_family':          'Outfit',
...
def build_qss(theme):
    ...
    QRadioButton::indicator:checked {{
        ...
        background-color: {c['radio_checked_gradient']};
    }}
    ...
    QComboBox::drop-down {{
        ...
        border:              {c['combobox_arrow_area_border']};
    }}
    ...
    QDateEdit::down-arrow {{ image: {c['dateedit_arrow_img']}; width: {c['dateedit_arrow_size']}px; height: {c['dateedit_arrow_size']}px; }}
    ...
    QCalendarWidget {{
        ...
        border-top:    {c['cal_border_top']};
        border-right:  {c['cal_border_right']};
        border-bottom: {c['cal_border_bottom']};
        border-left:   {c['cal_border_left']};
        min-height:    {c['cal_min_height']}px;
    }}
    QCalendarWidget QAbstractItemView {{
        font-family: {c['cal_view_font_family']};
        font-size:   {c['cal_view_font_size']};
        font-weight: {c['cal_view_font_weight']};
        background-color:           {c['cal_view_bg']};
        color:                      {c['cal_view_color']};
        selection-background-color: {c['cal_view_selected_bg']};
        selection-color:            {c['cal_view_selected_color']};
        gridline-color:             {c['cal_view_gridline']};
        outline:                    {c['cal_view_outline']};
    }}
    QCalendarWidget QAbstractItemView:disabled {{ color: {c['cal_view_disabled_color']}; }}
    QCalendarWidget QAbstractItemView::item:hover {{
        background-color: {c['cal_view_item_hover_bg']};
        color:            {c['cal_view_item_hover_color']};
        border-radius:    {c['cal_view_item_hover_radius']};
    }}
    QCalendarWidget QAbstractItemView::item:selected {{
        background-color: {c['cal_view_item_selected_bg']};
        color:            {c['cal_view_item_selected_color']};
        border-radius:    {c['cal_view_item_selected_radius']};
    }}
    QCalendarWidget QWidget#qt_calendar_navigationbar {{
        background-color: {c['cal_nav_bg']};
        padding:          {c['cal_nav_padding']};
        min-height:       {c['cal_nav_min_height']}px;
    }}
    QCalendarWidget QToolButton {{
        font-family: {c['cal_toolbtn_font_family']};
        font-size:   {c['cal_toolbtn_font_size']};
        font-weight: {c['cal_toolbtn_font_weight']};
        background-color: {c['cal_toolbtn_bg']};
        color:            {c['cal_toolbtn_color']};
        border-top:       {c['cal_toolbtn_border_top']};
        border-right:     {c['cal_toolbtn_border_right']};
        border-bottom:    {c['cal_toolbtn_border_bottom']};
        border-left:      {c['cal_toolbtn_border_left']};
        border-radius:    {c['cal_toolbtn_radius']};
        padding:          {c['cal_toolbtn_padding']};
        font-weight:      {c['cal_toolbtn_font_weight']};
    }}
    QCalendarWidget QToolButton:hover {{
        background-color: {c['cal_toolbtn_hover_bg']};
        border-radius:    {c['cal_toolbtn_hover_radius']};
    }}
    QCalendarWidget QToolButton::menu-indicator {{ image: {c['cal_toolbtn_menu_indicator']}; }}
    QCalendarWidget QToolButton#qt_calendar_prevmonth {{ qproperty-icon: {c['cal_arrow_prev_img']}; icon-size: {c['cal_arrow_icon_size']}px; }}
    QCalendarWidget QToolButton#qt_calendar_nextmonth {{ qproperty-icon: {c['cal_arrow_next_img']}; icon-size: {c['cal_arrow_icon_size']}px; }}
    QCalendarWidget QSpinBox {{
        font-family: {c['cal_spinbox_font_family']};
        font-size:   {c['cal_spinbox_font_size']};
        font-weight: {c['cal_spinbox_font_weight']};
        background-color:           {c['cal_spinbox_bg']};
        color:                      {c['cal_spinbox_color']};
        border-top:                 {c['cal_spinbox_border_top']};
        border-right:               {c['cal_spinbox_border_right']};
        border-bottom:              {c['cal_spinbox_border_bottom']};
        border-left:                {c['cal_spinbox_border_left']};
        selection-background-color: {c['cal_spinbox_selection_bg']};
    }}
    QCalendarWidget QSpinBox::up-button,
    QCalendarWidget QSpinBox::down-button {{ width: {c['cal_spinbox_updown_width']}; }}
    QCalendarWidget QHeaderView::section {{
        font-family: {c['cal_header_font_family']};
        font-size:   {c['cal_header_font_size']};
        font-weight: {c['cal_header_font_weight']};
        background-color: {c['cal_header_bg']};
        color:            {c['cal_header_color']};
        border-top:       {c['cal_header_border_top']};
        border-right:     {c['cal_header_border_right']};
        border-bottom:    {c['cal_header_border_bottom']};
        border-left:      {c['cal_header_border_left']};
        font-weight:      {c['cal_header_font_weight']};
    }}
    ...
    QCheckBox::indicator:disabled {{
        background-color: {c['checkbox_indicator_bg_disabled']};
        border-top:       {c['checkbox_indicator_border_top_disabled']};
        border-right:     {c['checkbox_indicator_border_right_disabled']};
        border-bottom:    {c['checkbox_indicator_border_bottom_disabled']};
        border-left:      {c['checkbox_indicator_border_left_disabled']};
        image:            {c['checkbox_indicator_img_disabled']};
    }}
    ...
    QPushButton[role="endtable-view"] {{
        ...
        color:            {c['btn_endtable_view_color']};
    ...
    QPushButton[role="endtable-edit"] {{
        ...
        color:            {c['btn_endtable_edit_color']};
    ...
    #CardBody {{
        ...
        border-width:     {c['card_body_border_width']};
        border-style:     {c['card_body_border_style']};
        border-color:     {c['card_body_border_color']};
